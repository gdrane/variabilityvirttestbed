...
struct variability_instruction_set arm_instructions [INSTRUCTIONS_AVAILABLE] = {
	...
	{"ORN_reg", 0, DATA_PROC_ISN},
	{"ORNS_reg", 0, DATA_PROC_ISN},
	{"MUL", 0, MULTIPLY_ISN},
	{"MVN_reg", 0, DATA_PROC_ISN},
	{"BIC_reg", 0, DATA_PROC_ISN},
	{"BIC_imm", 0, DATA_PROC_ISN},
	{"LDR_reg", 0, LDST_ISN},
	{"STR_reg", 0, LDST_ISN},
	{"STRH_reg", 0, LDST_ISN},
	{"STRB_reg", 0, LDST_ISN},
...
struct variability_instruction_set* get_map_entry(const char* instruction)
{
	...
	printf("%s Instruction not available", instruction);
	return NULL;
}
